...
class General extends Bot {
    ...
    public function debug($user, $channel, $args) {
    ...
    public function rickroll($user, $channel, $args) {
    ...
    public function join($user, $channel, $args) {
    ...
    public function part($user, $channel, $args) {
        if (!(user::IPhasPermission("core.command.join", $user))) {
            $this->bot->say_notice($user, "You dont have permission to use this command.");
        } else {
    ...
    public function say($user, $channel, $args) {
        $echo = implode(" ", $args);
